...
ManagerHeadPage::setTitle("Login with Email");

$client = $params['client'] ?? null;
$login_url = $client->createAuthUrl();
?>
<link rel="stylesheet" href="<?= CSS_PATH ?>auth/auth.css">
<link rel="stylesheet" href="<?= CSS_PATH ?>auth/with-email.css">
<link rel="stylesheet" href="<?= CSS_PATH ?>auth/email.css">
<link rel="stylesheet" href="<?= CSS_PATH ?>modal/popup.css">
...
<script src="<?= JS_PATH ?>modal/modal.js?v=<?= ASSETS_VERSION ?>" defer></script>
<script src="<?= JS_PATH ?>auth/login.js?v=<?= ASSETS_VERSION ?>" defer></script>