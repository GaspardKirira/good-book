...
ManagerHeadPage::setTitle("Login");

$client   = $params['client'] ?? null;
$loginUrl = $client ? $client->createAuthUrl() : '#';
$next     = isset($_GET['next']) ? trim($_GET['next']) : '';
?>
<link rel="stylesheet" href="<?= CSS_PATH ?>auth/login-auth.css?v=<?= ASSETS_VERSION ?>">
<style>
    .xa-shell {
        display: flex;
        align-items: center;
